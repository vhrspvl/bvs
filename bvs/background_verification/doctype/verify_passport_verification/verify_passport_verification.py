...
class VerifyPassportVerification(Document):
	pass

@frappe.whitelist()
def get_check(applicant_id):
	passport_verification_id = frappe.get_list("Passport Verification", filters={"applicant_id":applicant_id}, fields=("name"))
	# frappe.errprint(employment_check1_id)
	return passport_verification_id
