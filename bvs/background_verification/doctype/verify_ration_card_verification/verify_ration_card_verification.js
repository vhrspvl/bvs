	...
	refresh: function(frm){
		...
		if(frm.doc.applicant_id){
			frappe.call({
				...
				args:{
					doctype: "Ration Card Verification",
					filters:{
						"name": frm.doc.ration_card_verification_id
					 }
				},
				callback: function(r){
				   if(r.message){
					frm.set_value('ver_card_number', r.message.card_number);
					frm.set_value('ver_ward_number', r.message.ward_number);
					frm.set_value('ver_street_number', r.message.street_number);
					frm.set_value('ver_door_number', r.message.door_number);
					frm.set_value('ver_shop_name', r.message.shop_name);
					frm.set_value('ver_shop_number', r.message.shop_number);
