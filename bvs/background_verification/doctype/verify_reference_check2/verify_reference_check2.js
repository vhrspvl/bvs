...
frappe.ui.form.on("Verify Reference Check2", {
    after_save: function (frm) {
        ...
        if ((frm.doc.status == "Execution Completed") && ((frm.doc.result == "Positive") || (frm.doc.result == "Negative") || (frm.doc.result == "Amber") || (frm.doc.result == "Insufficient"))) {
            frappe.set_route("List", "Verify Reference Check2");
        }
        if (frm.doc.tat) {
    ...
    onload: function (frm) {
        ...
        frappe.call({
            "method": "bvs.background_verification.doctype.verify_reference_check2.verify_reference_check2.get_check",
            args: {
            ...
            callback: function (r) {
                $.each(r.message, function (i, d) {
                    if (r.message) {
                        frm.set_value("reference_check2_id", d.name);
                    }
                });
            }
    ...
    refresh: function (frm) {
        ...
        if (frm.doc.fields != "Updated") {
            frappe.call({
                ...
                args: {
                    doctype: "Reference Check2",
                    filters: {
                        "name": frm.doc.reference_check2_id
                    }
                },
                callback: function (r) {
                    if (r.message) {
        ...
        if ((frm.doc.allocated_for == "QC Pending") || (frm.doc.status == "QC Completed")) {
            frm.set_df_property('ver_reference_name', 'read_only', 0);
            frm.set_df_property('ver_company_name', 'read_only', 0);
            frm.set_df_property('ver_designation', 'read_only', 0);
            frm.set_df_property('ver_contact_number', 'read_only', 0);
