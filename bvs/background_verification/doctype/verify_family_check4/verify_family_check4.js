...
frappe.ui.form.on("Verify Family Check4", {
	...
	onload:function(frm){
		...
		frappe.call({
			"method": "bvs.background_verification.doctype.verify_family_check4.verify_family_check4.get_check",
			args: {
			...
			callback: function(r){
				$.each(r.message, function(i, d) {
					if(r.message){
						frm.set_value("family_check4_id", d.name);
					}
				});
			}
