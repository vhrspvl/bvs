...
frappe.ui.form.on('Verify ID Check5', {
    after_save: function (frm) {
        ...
        if ((frm.doc.status == "Execution Completed") && ((frm.doc.result == "Positive") || (frm.doc.result == "Negative") || (frm.doc.result == "Amber") || (frm.doc.result == "Insufficient"))) {
            frappe.set_route("List", "Verify ID Check5");
        }
    },
    onload: function (frm) {
        frappe.call({
            "method": "bvs.background_verification.doctype.verify_id_check5.verify_id_check5.get_check",
            args: {
