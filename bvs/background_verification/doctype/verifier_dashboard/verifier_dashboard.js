                ...
                if(r.message)	{
                	...
                	for(var i = 0;i < b; i++){
                        ...
                        $.each(r.message[i], function(i, d) {  
							...
							if(j == 22){
								row.checks = "Aadhar Card Verification";
							}
							if(j == 23){
								row.checks = "Pan Verification";
							}
							if(j == 24){
								row.checks = "Passport Verification";
							}
							if(j == 25){
								row.checks = "Voters ID Verification";
							}
							if(j == 26){
								row.checks = "Driving License Verification";
							}
							if(j == 27){
								row.checks = "Ration Card Verification";
							}
                        })	                              
                    }
                    refresh_field("verify_dashboard_list");						     
