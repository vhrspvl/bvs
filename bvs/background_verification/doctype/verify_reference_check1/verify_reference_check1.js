...
frappe.ui.form.on("Verify Reference Check1", {
    ...
    onload: function (frm) {
        ...
        frappe.call({
            "method": "bvs.background_verification.doctype.verify_reference_check1.verify_reference_check1.get_check",
            args: {
            ...
            callback: function (r) {
                $.each(r.message, function (i, d) {
                    if (r.message) {
                        frm.set_value("reference_check1_id", d.name);
                    }
                });
            }
    ...
    refresh: function (frm) {
        ...
        if (frm.doc.fields != "Updated") {
            frappe.call({
                ...
                args: {
                    doctype: "Reference Check1",
                    filters: {
                        "name": frm.doc.reference_check1_id
                    }
                },
                callback: function (r) {
                    if (r.message) {
