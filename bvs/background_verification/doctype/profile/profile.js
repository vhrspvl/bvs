...
frappe.ui.form.on('Profile', {
	...
	onload: function (frm) {
		frm.toggle_display(['employment', 'second_employment', 'third_employee', 'education', 'second_education', 'third_education', 'family_history', 'address_check', 'court_record',
			'criminal_check', 'reference_check', 'identity', 'pan_number_detail', 'aadhar_card_detail', 'voter_card_detail',
			'passport_details']);
			...
			frappe.call({
				...
				callback: function (r) {
					(r.message || []).forEach(function (d) {
						...
						if (d === "employment3") {
							frm.toggle_display('third_employee', d === "employment3");
						}
						if (d === "education1") {
