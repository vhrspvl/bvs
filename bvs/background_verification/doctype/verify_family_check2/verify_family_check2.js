...
frappe.ui.form.on("Verify Family Check2", {
	...
	onload:function(frm){
		...
		frappe.call({
			"method": "bvs.background_verification.doctype.verify_family_check2.verify_family_check2.get_check",
			args: {
			...
			callback: function(r){
				$.each(r.message, function(i, d) {
					if(r.message){
						frm.set_value("family_check2_id", d.name);
					}
				});
			}
